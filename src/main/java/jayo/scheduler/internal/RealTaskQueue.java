...
public sealed abstract class RealTaskQueue<T extends Task<T>> implements TaskQueue {
    /**
     * Returns the string "jayo.scheduler.TaskRunner" unless the library has been shaded for inclusion in another library. In such
     * cases, it will return a longer string like "com.example.shaded.jayo.scheduler.jayo.scheduler.TaskRunner". This makes it clear
     * which is which.
     */
